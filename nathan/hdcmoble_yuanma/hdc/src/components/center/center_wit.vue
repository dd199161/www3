...
.withdraw
 ...
 v-touch.t_btn(tag="button",@tap="$store.commit('wit_move')") 提现
</template>
<script>
	export default{
    mounted:function(){
   ...
   @import "../../assets/css/main.scss";
    ...
    color:#d0d0d0;
		table{
			...
			width:100%;
			td{
			  @extend %font24,%textAlign_center;
			}
		}
		.down_tip{
			padding-left:0.2rem;
