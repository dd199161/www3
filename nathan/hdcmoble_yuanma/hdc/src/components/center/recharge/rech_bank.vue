<template>
	<div class="bank">
	   <div class="rewrap" style="height:5.7rem;">
	   	  <div class="title" style="height:1.6rem;">
	   	  	    <p class="rehead">
	   	  	    	<span>★</span>
	   	  	    	选择充值
	   	  	    </p>
							<v-touch class="rechoice" :class="{'rechoiceh':ctoggle}" @tap="toggle">
								 <div class="bankpay_icon"></div>
								银联
							</v-touch>
	   	  </div>
	   	  <div class="input" style="height:3.125rem;box-sizing:border-box;">
	   	  	 <p class="rehead">
   	  	    	<span>★</span>
   	  	    	输入金额
	   	  	 </p>
