...
#app
  ...
  a.contact(href="https://chat6.livechatvalue.com/chat/chatClient/chatbox.jsp?companyID=80188&configID=53873&jid=4710603337&s=1",target="_self",v-if="$store.state.register.contact_toggle")
  .paynow(v-show='$store.state.paynowToggle')
   div
    a(target='_self',:href='"http://fastpay.hdc07.com/?site_id=3018&isMobile=1&username="+$store.state.register.Globalusername+"&domain="+$store.state.url')
    .paynow_bo
