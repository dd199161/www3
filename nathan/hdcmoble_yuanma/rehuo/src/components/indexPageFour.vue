...
#center.center
  .cshow
    ...
    p 主账户 :
      span {{$store.state.register.amountmoney}} 元
    v-touch.left(@tap='swiper(4)') 我要充值
    v-touch.right(@tap='swiper(5)') 我要提现
    .topNav
